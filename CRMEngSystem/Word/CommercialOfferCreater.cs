...
namespace CRMEngSystem.Word
{
    public sealed class CommercialOfferCreater
    {
        ...
        public CommercialOfferCreater(string filePath, Recipient recipient, Sender sender, DateTime date, string currency, PriceValues priceValues, IList<EquipmentEntry> equipmentList)
        {
            _filePath = filePath;
        ...
        public bool CreateCommercialOffer()
        {
            try
            {
